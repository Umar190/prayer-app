SUBSCRIPTION DISABLED — FUTURE PLAN ONLY

This document is not exposed in the live app.

# Noor Plus — Deferred

Subscriptions are intentionally disabled in the current Noor release. Keep this document as a future product plan only. Do not display or activate checkout links until the subscription system is deliberately reintroduced and tested.
