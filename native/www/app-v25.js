...
function openSettings(){
  ...
  const body=modal.querySelector('.settings-page-body'); if(body) body.scrollTop=0;
  fillCurrencySelects();
  fillMethodSelects();
  applyTheme();
